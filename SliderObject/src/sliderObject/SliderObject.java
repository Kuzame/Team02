...
//    private SliderObject slider;
  ...
  @Override public void start(final Stage primaryStage) {
    // create a slider.
	sliderObject = new Slider(0, 100, 50);
	sliderObject.setTooltip(new Tooltip(SLIDER_TOOLTIP));
    ...
    intField.valueProperty().bindBidirectional(sliderObject.valueProperty());
    intField.setPrefWidth(50);
 
    // layout the scene.
    Group root = new Group();
    root.setAutoSizeChildren(true);
    root.getChildren().addAll(sliderObject, text, intField);
    sliderObject.resizeRelocate(50,175,389,26);
    text.resizeRelocate(100,95,389,26);
    intField.resizeRelocate(255,125,389,26);
