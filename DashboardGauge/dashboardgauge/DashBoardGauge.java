...
//    	System.out.println (getClass().getResource(getClass().getSimpleName().toLowerCase() + ".css").toExternalForm());
//        return getClass().getResource("dashboardgauge.css").toExternalForm();
