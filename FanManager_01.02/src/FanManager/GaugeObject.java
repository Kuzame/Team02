 ...
 */
public class GaugeObject extends Region {
    ...
    private static final double     FRACTION        = 10;
    ...
    // ******************** Constructors **************************************
    public GaugeObject() {
//        getStylesheets().add(getClass().getResource("gaugeObject.css").toExternalForm());
        getStylesheets().add("FanManager/view/gaugeObject.css");

        getStyleClass().add("gaugeObject");
        aspectRatio               = DEFAULT_HEIGHT / DEFAULT_WIDTH;
        pane                      = new Pane();
        unitString                = new SimpleStringProperty("Fan 1\nSpeed");
//        unitString                = new SimpleStringProperty("°F");
    ...
    private void initGraphics() {
        ...
        unitFont = Font.font("sans serif", FontWeight.NORMAL, DEFAULT_WIDTH * 0.16);
    ...
    private void resize() {
        ...
        tickLabelFont = Font.font("sans serif", FontWeight.BOLD, size * 0.04);
        ...
        unitFont = Font.font("sans serif", FontWeight.NORMAL, size * 0.06);
        ...
        valueFont = Font.font("sans serif", FontWeight.NORMAL, size * 0.07);
